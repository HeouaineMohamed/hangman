...
export default function HangmanDrawing({numberOfGuesses}: Props) {
    const Head:ReactElement = (
        <div className='w-[50px] h-[50px] rounded-full border-black border-[5px] border-solid absolute top-[75px] -right-6'>

        </div>
    )
    const Body:ReactElement = (
        <div className='w-[7px] h-[100px] bg-black absolute top-[120px] right-[0px]'>

        </div>
    )
    const RightArm:ReactElement = (
        <div className='w-[7px] h-[60px] -rotate-45 bg-black absolute top-[140px] -right-[20px]'>
    ...
    const RightFoot:ReactElement = (
        <div className='w-[7px] h-[60px] -rotate-45 bg-black absolute top-[210px] -right-[20px]'>
